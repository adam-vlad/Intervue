...
/// Returns the full updated InterviewDto so the client always has the complete conversation state.
/// </summary>
public record SendMessageCommand(Guid InterviewId, string Content) : IRequest<Result<InterviewDto>>;
