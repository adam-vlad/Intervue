...
public static class MappingExtensions
{
    ...
    public static CvProfileSummaryDto ToSummaryDto(this CvProfile profile)
    {
        return new CvProfileSummaryDto(
            profile.Id,
            profile.DifficultyLevel,
            profile.Education,
            profile.CreatedAt,
            profile.Technologies.Select(t => t.Name).ToList());
    }

    public static InterviewSummaryDto ToSummaryDto(this Domain.Entities.Interview interview)
    {
        return new InterviewSummaryDto(
            ...
            interview.StartedAt,
            interview.CompletedAt,
            interview.Messages.Count,
            interview.FeedbackReport is not null,
            interview.FeedbackReport?.OverallScore);
    }
